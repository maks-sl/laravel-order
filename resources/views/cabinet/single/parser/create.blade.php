...
@section('content')
    ...
    <div class="card mb-3 p-4">
        <form method="POST" action="{{ route('cabinet.single.parser.store') }}">
            @csrf
            ...
            <div class="form-group">
                ...
                <input id="css_path" class="form-control{{ $errors->has('css_path') ? ' is-invalid' : '' }}" name="css_path" value="{{ old('css_path') }}" required>
            ...
            <div class="form-group">
                ...
                <input id="regex" class="form-control{{ $errors->has('regex') ? ' is-invalid' : '' }}" name="regex" value="{{ old('regex') }}">
                @if ($errors->has('regex'))
            ...
            <div class="form-group">
                ...
                <input id="match_group" class="form-control{{ $errors->has('match_group') ? ' is-invalid' : '' }}" name="match_group" value="{{ old('match_group') }}">
            ...
            <div class="form-group">
                ...
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="strip_tags" {{ old('strip_tags') ? 'checked' : '' }}> Strip tags
                    </label>
                </div>
